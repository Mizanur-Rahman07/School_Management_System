...
<head>
  ...
  <!-- AdminLTE Skins. Choose a skin from the css/skins
    ...
    <!-- table design css link start-->
 <link rel="stylesheet" href="https://cdn.datatables.net/1.11.4/css/dataTables.bootstrap4.min.css">
    <!-- table design css link end-->
  ...
  <link rel="stylesheet" href="<?php echo base_url()?>tools /assets/css/style.css">
</head>
        ...
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src=" <?php echo base_url()?>tools/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#"> 
                      <div class="pull-left">
                        <img src=" <?php echo base_url()?>tools/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Md.Mizanur Rahman</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="<?php echo base_url('School/category') ?>">
              <i class="fa fa-circle-o"></i> Category</a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="<?php echo base_url() ?>">
              <i class="fa fa-circle-o"></i> Classes</a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="<?php echo base_url() ?>">
              <i class="fa fa-circle-o"></i> Course</a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="<?php echo base_url() ?>">
              <i class="fa fa-circle-o"></i> Student Registrations</a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="<?php echo base_url() ?>">
              <i class="fa fa-circle-o"></i> Staff</a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="<?php echo base_url() ?>">
              <i class="fa fa-circle-o"></i> Exam</a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="<?php echo base_url() ?>">
              <i class="fa fa-circle-o"></i> Result</a></li>
        </ul>
      </li>
